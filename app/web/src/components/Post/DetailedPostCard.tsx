...
const DetailedPostCard = (props: DetailedPostCardProps) => {
  ...
  const { mutate: upvoteSpot } = useUpvoteSpot({
    config: {
      onSuccess: (data: any) => {
        const vote = votesOnSpot.filter(
          (datum: { enigmaUser: { id: number } }) => {
              ...
              <div className="card-body">
                ...
                <span className="m-3 d-flex justify-content-between">
                  <span className="d-flex">
                    ...
                    />
                    <span className="WA-theme-negative fw-bold fs-6">
                      {" "}
                      {downvotes}{" "}
                    </span>
                  </span>
                  {enigmaUser.id == userData.id ? (
                    <span className="d-flex">
                      <Link
                        ...
                        style={{ textDecoration: "none" }}
                        className="btn-primary btn WA-theme-bg-main"
                      >
                        Edit Spot
                      </Link>
                    </span>
