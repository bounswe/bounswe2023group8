...
const BunchVisitor: React.FC<BunchVisitorProps> = () => {
    const backgroundImageUrl = 'https://img.freepik.com/premium-vector/hand-drawn-vector-illustration-brain-head-open-pattern-white-background_630651-117.jpg?w=2000';
    ...
    return (
        <Container fluid style={{ height: '100vh', backgroundImage: `url(${backgroundImageUrl})`, backgroundSize: 'cover' }}>

            <Row>
                {/* Left Part */}
                <Col xs={8}>
                    {/* Interest Area Card */}
                    <Card className="mt-3 mb-3 bg-light text-center rounded-4 d-inline-block" style={{ minHeight: 'fit-content' }}>
                        <Card.Body>
